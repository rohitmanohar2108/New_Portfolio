...
const About = () => {
  return (
    ...
    >
      {/* Half background */}
      <div className="absolute inset-0 h-1/2 bg-secondary"></div>
          ...
          <FadeInView>
            <div className="relative p-6 bg-background rounded-lg shadow-lg">
              ...
              <p className="text-text-body text-lg leading-relaxed">
                ...
                about learning and applying modern web development technologies.
                I focus on building clean, efficient, and user-friendly
                applications while continuously improving my skills and
          ...
          {[
            ...
            >
              <motion.div
                ...
                className="p-6 rounded-xl bg-secondary dark:bg-gradient-to-br from-gray-800 to-gray-900 dark:border dark:border-white/10 dark:hover:border-white/20 hover:shadow-lg transition-all duration-200"
              >
                <feature.icon className="w-12 h-12 mb-4 text-primary" />
                <h3 className="text-xl font-bold text-text-heading mb-2">{feature.title}</h3>
