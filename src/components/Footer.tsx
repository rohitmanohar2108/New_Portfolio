      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 mb-8">
          ...
          <div>
            ...
            <p className="mb-6 font-extralight">Looking for opportunities to create impactful solutions and
            ...
            <form className="space-y-4">
              ...
              >
                <span className='font-extralight'>Send Message</span>
          ...
          <div className="md:text-right">
            ...
            <p className="mb-6 font-extralight">Connect with me on my social media channels:</p>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-8 text-center font-extralight">
